            ...
            <div class="col-10 col-md-12">
                <nav class="text-center my-5">
                   ...
                   @foreach ($posts as $post )
                      <a href="#" class="mx-3 pb-3 link-category d-block d-md-inline">{{$post->category->name}}</a>
                   @endforeach
                </nav>
            </div>
        </div>
                ...
                <div class="col-10">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-12 justify-content-center mb-5">
                            <div class="card m-auto" style="width: 18rem; rounded">
                                <img src="http://localhost:8000/storage/{{$post->image_url}}" alt="{{$post->name}}" class="rounded img-fluid">
                                <div class="card-body">
                                    ...
                                    <a href="/{{$post->slug}}" class="post-link"><b>Leer Mas</b></a>
                                    <hr>
                                    <div class="row">
